...
const TabLight = ({ items = ["item1", "item2"], onChange = () => {}, className }) => {
      ...
      {items.map((item, i) => {
        return (
          <div
            ...
            className={`${
              active == i ? "border-b-2 border-solid border-0 border-pv_primary text-pv_primary" : "border-b-2 border-solid border-0 border-transparent text-label"
