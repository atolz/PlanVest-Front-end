...
const InvestApplication = ({ className }) => {
  ...
  return (
    <PlainContainerTitle className={`${className} pb-[4rem]`} title="Investment Application" actionText={<span className=" font-rubik text-[#137C4B] text-[1.8rem] font-semibold">View All</span>}>
