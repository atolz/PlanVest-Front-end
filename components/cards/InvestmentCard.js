...
const InvestmentCard = ({status, text, onClick, userName='Alhiyu Sambara', ltContent='Business Name', lbContent='Sambara Farms', rtContent='Application Date', rbContent='23/05/2022'}) => {
  return (
    <div className='w-[320px] bg-white p-[3rem] rounded-xl ' onClick={onClick}>
        ...
        <div className='flex flex-col mt-[2rem] gap-[1rem] '>
            ...
            <p className='w-[full] items-start text-[#9999B4] text-[14px] '>Sambara farms is a livestock farm. We rear cows, goats, sheeps and have a poultry.  <span className='text-[#137C4B] cursor-pointer'>Read More</span></p>
        </div>
