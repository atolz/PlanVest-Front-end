...
const SignUp = () => {
  ...
  const onRegister = async (values) => {
    ...
    if (data.status) {
      ...
      router.push(`/cooperative-admin/register?email=${values?.email}`);
      openModal();
  ...
  return (
    <OnboardingLayout signup={true}>
       {/* {start party pop up modal} */}
        
    {/* { register && <VerifyModal
      ...
      <div className="max-w-[49.2rem] w-full  my-[auto]">
              ...
              return (
                <Form className="grid gap-[1.9rem]">
                  ...
                  <p className=" font-medium text-[1.6rem] text-text">
                    ...
                    <Link href={"/cooperative-admin/signin"} passHref>
        ...
        {/* <form className="grid gap-[1.9rem]">
         <TextField name="id-Name" type={"name"} id="Email" placeholder="Shell Cooperative" label="Name" variant="filled" />
         <TextField name="id-Email" type={"email"} id="Email" placeholder="WinnerOkpere@gmail.com" label="Email" variant="filled" />
         <TextField name="id-Number" type={"tel"} id="Email" placeholder="+234 906 598 424" label="Phone Number" variant="filled" />
         <TextField name="id-Pin" type={"number"} id="Email" label="Transaction Pin" variant="filled" />
        <TextField
            name="id-passwordd"
            InputProps={{
              endAdornment: (
          ...
          <p className="text-pv_dark">I agree to all the <span className="text-pv_primary cursor-pointer" onClick={terms}>Terms, Privacy Policy</span> and <span className="text-pv_primary"> Fees</span></p>
          </div>
         <LoadingButton
            onClick={setRegister}
            loading={loading}
          ...
          <p className="text-pv_dark">Already have an account?<span className="text-pv_primary cursor-pointer" onClick={signin}>Log in</span></p>
       </form> */}
      </div>
    </OnboardingLayout>
  );
